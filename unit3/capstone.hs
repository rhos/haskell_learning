...
median xs =
  ...
  where
    ...
    isEven = listLength `mod` 2 == 0
    v1 = realToFrac (sorted !! (listLength `div` 2))
    v2 = realToFrac (sorted !! (listLength `div` 2 - 1))
